...
using IEA_ErpProject101_Main.Urun_Islemleri;
using System;
...
namespace IEA_ErpProject101_Main
{
    public partial class Home : Form
    {
        ...
        private void MenuOlustur()
        {
            ...
            tvBilgiGirisIslemleri.Nodes[1].Nodes.Add("Doktorlar Bilgi Giriş");
        ...
        private void tvBilgiGirisIslemleri_DoubleClick(object sender, EventArgs e)
        {
            ...
            else if(isim=="Doktorlar Bilgi Giriş" && Application.OpenForms["frmDoktorGiris"] is null)
            {
        ...
        private void tvUrunIslemleri_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (isim == "Urunler Listesi" && Application.OpenForms["frmUrunleristesi"] is null)
            {
            ...
            else if (isim == "Urun Giris" && Application.OpenForms["frmUrunGiris"] is null)
            {
        ...
        private void tvDepoIslemleri_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (isim == "Stok Giris" && Application.OpenForms["frmStokGiris"] is null)
            {
